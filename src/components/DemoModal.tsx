...
const DemoModal = ({ onClose }: DemoModalProps) => {
  return (
    ...
    <div
      className=" fixed inset-0 z-9999 flex justify-center bg-black/60  py-16 md:py-20 px-100 "
      onClick={onClose}
    >
      ...
      >
        ...
        <h2 className="mb-1 text-center text-2xl font-extrabold text-teal-700">
