...
const Hero = () => {
  return (
    <section className="bg-[#f7f9f8] mt-10 px-6 pb-140px pt-60px md:pt-6">
      <div
        className=
      ...
      >
        ...
        <div className="mx-auto w-full max-w-900px">
          <img
            src={badgeImg}
            alt="Hero badge"
            className="mx-auto pt-9 opacity-0 animate-fade-up"
          />

          <h1 className="opacity-0 animate-fade-up-delay-1 text-[28px] font-medium leading-tight md:text-[30px]">
          ...
          <p className=" font-bold mt-4 animate-fade-up-delay-2 pb-10 text-[12px] opacity-70 md:text-[10px]">
        ...
        <img
          src={dashboardImg}
          alt="Dashboard"
          className="z-20 mx-auto mt-auto w-full max-w-full rounded-[14px] shadow-[0_30px_60px_rgba(0,0,0,0.35)] opacity-0 animate-image-pop md:w-[85%] md:max-w-950px"
        />
      </div>
    </section>
  );
